...
//here we are managing external api with action
...
const {
  ...
  restaurants,
  showVegOnly
} = useSelector((state)=> state.restaurants) //used to get data from the store
//we use this data to make the webpage dynamic


useEffect(()=>{
  dispatch(getRestaurants()) //used to dispatch data to the store
},[dispatch]);
...
const handleToggleVegOnly=()=>{
  ...
  <>
    <CountRestaurant />
    {restaurantsLoading ? <Loader /> : restaurantsError ? (<Message variant="danger">{restaurantsError}</Message>) :( <section>
        <div className="sort">
