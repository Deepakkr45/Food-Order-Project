...
const onChange=(e)=>{
  if(e.target.name==="avatar"){
    ...
    //helps to read the content of files in userdata
    reader.onload=()=>{
      if(reader.readyState===2){//if the reading is done
        setAvatarPreview(reader.result);
        setAvatar(reader.result);
      }
    };
    reader.readAsDataURL(e.target.files[0]);//reads the first file and triggers the on load
  }else{
